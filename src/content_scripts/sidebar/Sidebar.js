...
class LeftSidedBar extends PositioningStatus{

	toggleSide(){
		this.context.moveRight();
		this.context.positioningStatus = new RightSidedBar(this.context);
	};
}
...
class RightSidedBar{
	...
	toggleSide(){
		this.context.moveLeft();
		this.context.positioningStatus = new LeftSidedBar(this.context);
	};
}
...
class OpenSidebar extends SidebarStatus{

	close () {
		this.context.widget.style.display = "none";
		this.context.displayStatus = new ClosedSidebar(this.context);
...
class ClosedSidebar extends SidebarStatus{
	open () {
		this.context.widget.style.display = "";
		browser.runtime.sendMessage({ call: "onFrameReadyForLoadingUrl" });
		this.context.displayStatus = new OpenSidebar(this.context);
	};
	toggle () {
		this.open();
	};
